...
monthly %>% mutate(calyear = case_when(spanel == 2014 & swave == 1 ~ 2013, 
...
## Excluding military 
We decided to exclude those in the military and those who were ever employed as "other" employment type. So I drop those here.
...
to_table <- full_time_period_flags %>% 
  ...
  mutate(
    ...
    tpearn = case_when(
      calyear == 2013 ~ tpearn * 292.7/233.0,
