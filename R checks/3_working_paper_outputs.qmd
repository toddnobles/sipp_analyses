...
se_sample <- se_sample %>% 
  mutate(y1_status_v2 = factor(y1_status_v2, labels = c("W&S", "Self-Employed", "Unemployed")),
         ...
         unemp_f12_3 = factor(ifelse(unemp_f12 >= 3, 1,0), labels = c("Not Unemployed", "Unemployed 3+")))
...
mapping <- c(
  # Main Variables of Interest
  "unemp_f12_3Unemployed 3+" = "Unemployed 3+",
  "race_eth_fct_cpsdNon_white" = "Non-White",
  "industry_experience" = "Prior Industry Experience: Yes",
  "unemp_f12_3Unemployed 3+:industry_experience" = "Unemployed*Prior Industry Experience",
...
rows_to_add <- tribble(
 ...
 #  "Professional, Scientific, and Management, and Administrative, and Waste Management Services (Reference)", "", "", "", "", "", "" # 28
)
attr(rows_to_add, 'position') <- c(1, 3, 5, 8, 12, 14, 16, 18, 21)
```
