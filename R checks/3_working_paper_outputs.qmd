...
se_sample <- readRDS("se_sample.rds") %>% ungroup()
```
...
### Table 3 Unemployment Regression

```{r table unemp earnings regular se}

	
sjPlot::tab_model(unemp_m1_plm,
                                       unemp_m2_plm, 
                                       unemp_m3_plm, 
                                       unemp_m4_plm,
                  collapse.ci = TRUE,  
                  p.style = "stars", 
                  prefix.labels = "label", 
                  title = "Table 3 Unemployment Predicting log annual earnings")


tbl3_unemp_models <- modelsummary(list(unemp_m1_plm,
                                       unemp_m2_plm, 
                                       unemp_m3_plm, 
                                       unemp_m4_plm), 
                                  coef_rename = TRUE, 
                           ...
                           statistic = NULL,
                           title = "Table 3 Unemployment predciting Log Annual Earnings", 
             output = "gt")
addWorksheet(wb, "Tbl 3 Reg Unemp Earn")
writeData(wb, tbl3_unemp_models, sheet = "Tbl 3 Reg Unemp Earn")
...
sjPlot::tab_model(unemp_m1_plm,
                  ...
                  title = "Table 3 RSE Unemployment Predicting log annual earnings")
...
sjPlot::tab_model( unemp_m1_plm_wt,
                   unemp_m2_plm_wt,
                   unemp_m3_plm_wt,
                   unemp_m4_plm_wt,
                  collapse.ci = TRUE,
                  p.style = "stars",
                  prefix.labels = "label",
                  title = "Table 3 Weights Unemployment and Log Annual Earnings")
...
sjPlot::tab_model( status_m1_plm,
                   status_m2_plm,
                   status_m3_plm,
                   status_m4_plm,
                  collapse.ci = TRUE,
                  p.style = "stars",
                  prefix.labels = "label",
                  title = "Table 4 Year 1 Status and Log Annual Earnings")
tbl4_status_earn <- modelsummary(list(status_m1_plm,
                   ...
                   status_m4_plm), 
                                  ...
                                  estimate = "{estimate} ({std.error}){stars}",
                           statistic = NULL,
                           title = "Table 4  Y1 Status predciting Log Annual Earnings", 
             output = "gt")
...
sjPlot::tab_model( status_m1_plm,
                  ...
                  prefix.labels = "label",
                  vcov.args = list(cluster = person_year$ssuid_spanel_pnum), vcov.fun = "CR1",
                  title = "Table 4 Status  RSE and Log Annual Earnings")
...
tbl4_status_earn_rse <- modelsummary(list(status_m1_plm,
                   ...
                   vcov = "robust",
                           statistic = NULL,
                           title = "Table 4 RSE Y1 Status predciting Log Annual Earnings", 
             output = "gt")
...
sjPlot::tab_model( m1_unemp_prftb,
                  ...
                  p.style = "stars",
                  prefix.labels = "label",
                  title = "Unemployment and Positive Profit Log odds")
...
sjPlot::tab_model( m1_unemp_prftb_wt,
                  ...
                  p.style = "stars",
                  prefix.labels = "label",
                  title = "Unemployment and Positive Profit with weights Log odds")
```
...
sjPlot::tab_model( m1_unemp_prftb10,
                  ...
                  p.style = "stars",
                  prefix.labels = "label",
                  title = "Unemployment and 10k Profit log odds")
```
