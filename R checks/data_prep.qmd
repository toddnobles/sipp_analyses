...
Business value is the primary issue above. Shouldn't be possible to have business value missing if SE. For now we don't drop them since we're really just concerned with employment. 
```{r cleanup missings}
se_sample <- se_sample %>%
  filter(if_all(
    c(
