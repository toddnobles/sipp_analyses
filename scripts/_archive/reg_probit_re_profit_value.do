...
//log file
capture log close
log using reg_probit_re_profit_reported, text replace

****Model with race and debt interaction first and then adding wealth variables

foreach x of varlist profposi prof10k {
	
xtprobit `x' i.black $educ $controls, re vce(robust)
eststo `x'_1

xtprobit `x' i.black log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_2

xtprobit `x' i.black##c.log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_3

xtprobit `x' i.black##c.log_thdebt_ed log_thnetworth $educ $controls, re vce(robust)
eststo `x'_4
...
**BLack and white sample separately
eststo clear

foreach x of varlist profposi prof10k {
    
xtprobit `x' $educ $controls if black==1, re vce(robust)
eststo `x'_1
xtprobit `x' $educ $controls if black==0, re vce(robust)

xtprobit `x'  log_thdebt_ed $educ $controls if black==1, re vce(robust)
eststo `x'_2
xtprobit `x'  log_thdebt_ed $educ $controls if black==0, re vce(robust)

xtprobit `x' log_thdebt_ed log_thnetworth $educ $controls if black==1, re vce(robust)
eststo `x'_4
xtprobit `x' log_thdebt_ed log_thnetworth $educ $controls if black==0, re vce(robust)
...
xtprobit `x' i.black $controls if `y'==1, re vce(robust)
eststo `x'_1

xtprobit `x' i.black log_thdebt_ed $controls if `y'==1, re vce(robust)
eststo `x'_2

xtprobit `x' i.black##c.log_thdebt_ed $controls if `y'==1, re vce(robust)
eststo `x'_3

xtprobit `x' i.black##c.log_thdebt_ed log_thnetworth $controls if `y'==1, re vce(robust)
eststo `x'_4
...
xtprobit `x' i.black log_thdebt_ed log_thnetworth $educ $controls, re vce(robust)
eststo `x'_2
...
xtprobit `x' i.black##c.log_thnetworth $educ $controls, re vce(robust)
eststo `x'_5

xtprobit `x' i.black##c.log_thnetworth log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_6
}

foreach x of varlist log_prof log_bvalue {
xtreg `x' i.black $educ $controls, re vce(robust)
eststo `x'_1
xtreg `x' i.black log_thdebt_ed log_thnetworth $educ $controls, re vce(robust)
eststo `x'_2
xtreg `x' i.black##c.log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_3

xtreg `x' i.black##c.log_thdebt_ed log_thnetworth $educ $controls, re vce(robust)
eststo `x'_3

xtreg `x' i.black##c.log_thnetworth $educ $controls, re vce(robust)
eststo `x'_4

xtreg `x' i.black##c.log_thnetworth log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_4
}
...
xtreg `x' i.black log_thdebt_ed $educ $controls, re vce(robust)
eststo `x'_2
...
xtreg `x' i.black $educ $controls, fe vce(robust)
eststo `x'_1

xtreg `x' i.black log_thdebt_ed log_thnetworth $educ $controls, fe vce(robust)
eststo `x'_2

xtreg `x' i.black##c.log_thdebt_ed log_thnetworth $educ $controls, fe vce(robust)
eststo `x'_3

xtreg `x' i.black##c.log_thnetworth log_thdebt_ed $educ $controls, fe vce(robust)
eststo `x'_4
}

/*
esttab profposi* prof10k* using reg8_busvalprofit_tables_clust_householdnetworth4.csv, ///
star (* 0.05 ** 0.01 *** 0.001) compres title("Table 1 coef: profposi & prof10k75, 18-64 years old") ///
mtitles("profposi" "profposi" "profposi" "profposi" "prof10k" "prof10k" "prof10k" "prof10k") replace

esttab profposi* prof10k* using reg8_busvalprofit_tables_clust_householdnetworth4, eform ///
star (* 0.05 ** 0.01 *** 0.001) compres title("Table 3 OR: profposi & prof10k75, 18-64 years old") ///
mtitles("profposi" "profposi" "profposi" "profposi" "prof10k" "prof10k" "prof10k" "prof10k") append

//Words doctor
esttab profposi* prof10k* using reg8_busvalprofit_tables_clust_householdnetworth4.rtf, ///
star (* 0.05 ** 0.01 *** 0.001) compres title("Table 1 coef: profposi & prof10k75, 18-64 years old") ///
mtitles("profposi" "profposi" "profposi" "profposi" "prof10k" "prof10k" "prof10k" "prof10k") replace
