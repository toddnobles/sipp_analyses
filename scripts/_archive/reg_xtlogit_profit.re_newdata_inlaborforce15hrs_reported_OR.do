...
capture log close
log using reg_xtlogit_profit.re_newdata_15hrs_reported_OR, text replace
...
esttab profposi* prof10k* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label ///
...
esttab profposib* profposiw* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label ///
star (* 0.05 ** 0.01 *** 0.001) compres title("Positive Profit and Profit of $10K or More") ///
mtitles("profposib" "profposib" "profposib" "profposiw" "profposiw" "profposiw" ) append

esttab prof10kb* prof10kw* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label ///
star (* 0.05 ** 0.01 *** 0.001) compres title("Positive Profit and Profit of $10K or More") ///
...
esttab hsorlesprofposi* somcolorassoprofposi* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label ///
...
esttab collegeprofposi* graddegprofposi* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label  ///
...
esttab hsorlesprof10k* somcolorassoprof10k* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label  ///
...
esttab collegeprof10k* graddegprof10k* using reg_xtlogit_profit.re_newdata_inlaborforce_15hrs_reported_OR.csv, eform label  ///
